...
const ItemList = ({ address, attributes, images, description, star, title, user }) => {
    return (
        <div className='w-full flex border-t border-orange-600 py-3'>
            <div className='w-2/5 flex flex-wrap gap-[2px] items-center relative cursor-pointer'>
                ...
                <span className='bg-transparent-70 text-white px-2 rounded-md absolute left-1 bottom-4'>{`${images.length} ảnh`}</span>
            </div>
            <div className='w-3/5'>
